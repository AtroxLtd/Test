...
public class D1S1PartScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d1_s1_part_screen);

        mOrder = (Button) findViewById(R.id.btnOrder);
        mItemSelected = (TextView) findViewById(R.id.tvItemSelected);
        listItems = getResources().getStringArray(R.array.list_1);
        ...
        sendEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                msg = (TextView) findViewById(R.id.tvItemSelected);
        ...
        mOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(D1S1PartScreen.this);
        ...
        ListView d1s1List = (ListView) findViewById(R.id.d1S1List);
        d1s1List.setAdapter(myAdapter);

        d1s1List.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        String part = String.valueOf(parent.getItemAtPosition(position));
                        Toast.makeText(D1S1PartScreen.this, part, Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
