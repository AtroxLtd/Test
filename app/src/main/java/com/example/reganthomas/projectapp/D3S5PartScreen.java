...
public class D3S5PartScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d3_s5_part_screen);

        mOrder = (Button) findViewById(R.id.orderButton);
        mItemSelected = (TextView) findViewById(R.id.orderText);
        listItems = getResources().getStringArray(R.array.list_23);
        ...
        mOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(D3S5PartScreen.this);
        ...
        ListView d3s5List = (ListView) findViewById(R.id.d3S5List);
        d3s5List.setAdapter(myAdapter);

        d3s5List.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        String part = String.valueOf(parent.getItemAtPosition(position));
                        Toast.makeText(D3S5PartScreen.this, part, Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
