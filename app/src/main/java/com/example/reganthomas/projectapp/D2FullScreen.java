...
public class D2FullScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d2_full_screen);

        mOrder = (Button) findViewById(R.id.orderButton);
        mItemSelected = (TextView) findViewById(R.id.orderText);
        listItems = getResources().getStringArray(R.array.list_29);
        ...
        mOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(D2FullScreen.this);
                mBuilder.setTitle("Drill 2");
        ...
        ListView d2Full1List = (ListView) findViewById(R.id.d2FullList);
        d2Full1List.setAdapter(myAdapter);

        d2Full1List.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        String part = String.valueOf(parent.getItemAtPosition(position));
                        Toast.makeText(D2FullScreen.this, part, Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
